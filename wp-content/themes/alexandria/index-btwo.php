    	...
    	<div class="biztwo-portfolio">
            ...
            <div class="biztwo-portfolio-item">
            	...
            	<p class="biztwo-portfolio-item-image">
                	<img src="<?php echo esc_url( of_get_option('biztwo_port_one_image') ); ?>" />
                </p>
            ...
            <div class="biztwo-portfolio-item">
            	...
            	<p class="biztwo-portfolio-item-image">
                	<img src="<?php echo esc_url( of_get_option('biztwo_port_two_image') ); ?>" />
                </p>
            ...
            <div class="biztwo-portfolio-item">
            	...
            	<p class="biztwo-portfolio-item-image">
                	<img src="<?php echo esc_url( of_get_option('biztwo_port_three_image') ); ?>" />
                </p>
            ...
            <div class="biztwo-portfolio-item">
            	...
            	<p class="biztwo-portfolio-item-image">
                	<img src="<?php echo esc_url( of_get_option('biztwo_port_four_image') ); ?>" />
                </p>
