...
final class Get_The_Image {
	...
	public function __construct( $args = array() ) {
		...
		$defaults = array(
			...
			'the_post_thumbnail' => null, // @deprecated 0.9.0 Use 'featured'.
			'image_scan'         => null, // @deprecated 0.9.0 Use 'scan' or 'scan_raw'.
			'default_image'      => null, // @deprecated 0.9.0 Use 'default'.
			'order_of_image'     => null, // @deprecated 0.9.0 No replacement.
		);
