...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options','alexandria'), __('Theme Options','alexandria'), 'edit_theme_options', 'options-framework','optionsframework_page');
    ...
    <div class="new_options_container">
    	...
    	<div id="countrytabs" class="new_options_container_middle">
			...
			<ul class="shadetabs">
                ...
                <li class="small"><a href="#country6"><p><?php echo __('Header One Settings', 'alexandria'); ?></p></a></li>                 
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'alexandria' ), 'updated fade' );
	...
	if ( isset( $_POST['update'] ) ) {
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'alexandria' ), 'updated fade' );
		return $clean;
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options', 'alexandria' ),
