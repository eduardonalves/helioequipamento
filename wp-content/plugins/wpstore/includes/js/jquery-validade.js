...
$.extend($.validator, {
	...
	messages: {
		...
		date: "Digite um data válida.",
		dateISO: "Digite um data válida (ISO).",
		...
		max: $.validator.format("Digite um valor menor que ou igual a {0}."),
		min: $.validator.format("Digite um valor maior que ou igual a {0}.")
	},
